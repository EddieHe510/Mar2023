...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TMFeature", "As a Turnup portal admin\r\nI would like to create, edit time and material records\r" +
                    "\nSo that I can manage emplyees time and materials successfully", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 9
 testRunner.Given("I logged into turn portal successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Edie existing time and material record with valid details")]
        [NUnit.Framework.TestCaseAttribute("Time", "test", "20", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "Keyboard", "100", null)]
        [NUnit.Framework.TestCaseAttribute("EditedRecord", "Mouse", "500", null)]
        public void EdieExistingTimeAndMaterialRecordWithValidDetails(string description, string code, string price, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Edie existing time and material record with valid details", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 14
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
